(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root['SimditorAutosave'] = factory(root["jQuery"],root["SimpleModule"],root["Simditor"]);
  }
...
SimditorAutosave = (function(superClass) {
  ...
  SimditorAutosave.prototype._init = function() {
    ...
    return this._loadStorage(val);
  };

  SimditorAutosave.prototype._loadStorage = function(val) {
    if (this.editor.textarea.is('[data-autosave-confirm]')) {
      this.editor.el.append("<p class=\"simditor-autosave-toolbar\">\n  " + (this.editor.textarea.data('autosave-confirm') || 'Are you sure to restore unsaved changes?') + "\n  <a href=\"javascript:;\" class=\"link-autosave-recover\">恢复</a>\n  <a href=\"javascript:;\" class=\"link-autosave-ignore\">忽略</a>\n</p>");
      this.editor.el.find('.link-autosave-recover').one('click', (function(_this) {
        return function() {
          _this.editor.setValue(val);
          return _this.editor.el.find('.simditor-autosave-toolbar').remove();
        };
      })(this));
      return this.editor.el.find('.link-autosave-ignore').one('click', (function(_this) {
        return function() {
          _this.storage.remove(_this.path);
          return _this.editor.el.find('.simditor-autosave-toolbar').remove();
        };
      })(this));
    } else {
